...
SERVICE_NAME="l4t-ds-opencv-ffmpeg-${CUDA_COMPUTE_CAPABILITY}"

# build servicebroker
DOCKER_BUILDKIT=0 docker build --progress=plain -f ${DOCKERFILE_DIR}/Dockerfile-pylib-ds-opencv-ffmpeg -t ${SERVICE_NAME}:"${DATE}" \
