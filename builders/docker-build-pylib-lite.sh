...
SERVICE_NAME="pylib-lite"
DOCKERFILE_DIR="./dockerfiles/${SERVICE_NAME}"

DOCKER_BUILDKIT=1 docker build --progress=plain -f ${DOCKERFILE_DIR}/Dockerfile -t ${SERVICE_NAME}:"${DATE}" .
# tagging
